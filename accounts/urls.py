...
urlpatterns = [
    ...
    path('reset-password', auth_views.PasswordResetView.as_view(template_name="accounts/password_reset.html", success_url='accounts:password_reset_done'), name="password_reset"),
